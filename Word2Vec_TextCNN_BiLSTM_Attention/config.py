...
save_model = '/root/news_text_classification/Word2Vec_TextCNN_BiLSTM_Attention/cnn.bin'
save_test = '/root/news_text_classification/Word2Vec_TextCNN_BiLSTM_Attention/cnn.csv'
